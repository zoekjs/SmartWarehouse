        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info">
                        <p class="d-block">
                            {{ Auth::user()->name . ' ' . Auth::user()->last_name . ' ' . '(' . Auth::user()->role->name . ')' }}
                        </p>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('estado-oc') }}" class="nav-link">
                                ...
                                <p>Restaurar elementos</p>
                                <i class="right fas fa-angle-left"></i>
                            </a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('restore-products') }}" class="nav-link">
                                        <p>Productos</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('restore-providers') }}" class="nav-link">
                                        <p>Proveedores</p>
                                    </a>
                                </li>
                            </ul>
