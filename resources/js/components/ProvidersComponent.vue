                    ...
                    <div class="form-group col-sm-6 ml-3">
                        <div class="input-field">
                            ...
                            <input
                                ...
                                maxlength="8"
                            />
                            <span v-if="!rutValidatorCheck" class="text-danger"
                ...
                <div class="form-group">
                    <div class="form-group col-sm-12">
                        ...
                        <input
                            ...
                            maxlength="25"
                        />
                        <span v-if="!emailValidatorCheck" class="text-danger"
                            >El email ingresado no es válido</span
                        >
                    </div>
                </div>
            ...
            <template v-slot:cell(actions)="row">
                <div class="d-flex justify-content-around">
                    <b-button
                        ...
                        @click="
                            (show = !show), setSelectedProviderData(row.item)
                        "
                    >
                        <b-icon
                            icon="pencil-square"
                    ...
                    <b-button
                        ...
                        @click="deleteProvider(row.item.rut_provider)"
                    >
...
export default {
    ...
    methods: {
        ...
        createProvider() {
            const payload = {
                rut_provider: this.rutProvider,
                dv: this.dv,
                name: this.name,
                telephone: this.telephone,
                address: this.address,
                email: this.email,
                id_pais: this.selectedCountry,
        ...
        setSelectedProviderData(item) {
            ...
            this.dv = this.editRutProvider.substring(
                this.editRutProvider.length,
                8
            );
            this.rutProvider = this.editRutProvider.substring(
                0,
        ...
        updateProvider() {
            const payload = {
                rut_provider: this.editRutProvider,
                name: this.name,
                telephone: this.telephone,
                address: this.address,
                email: this.email,
                id_country: this.selectedCountry,
                rut_user: this.rutUser
            };
