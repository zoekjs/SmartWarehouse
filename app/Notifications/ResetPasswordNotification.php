...
class ResetPasswordNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line('Recibes este correo electrónico porque se solicitó un cambio de contraseña para tu cuenta.')
            ->action('Reestablecer contraseña', url(route('password.reset', ['token' => $this->token,'email' => $notifiable->getEmailForPasswordReset()], false)))
            ->line('Si no relizaste esta petición, puedes ignorar este correo.')
            ->salutation('¡Saludos!');
    }
